            ...
            <div className='w-full max-w-lg px-10 py-8 mx-auto'>
                <div className='max-w-md mx-auto space-y-6'>
                    <div className="dropdown-menu" aria-label="User menu">
                        <div className="bg-white rounded-lg shadow-xl flex items-center px-4 py-6 cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
                            <input type="text" placeholder="Juma Musa" readOnly className="pointer-events-none text-base placeholder-gray-400 outline-none w-full h-full flex-1" />
